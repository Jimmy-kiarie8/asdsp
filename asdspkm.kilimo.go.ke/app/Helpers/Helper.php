...
{
    $data = array(
       "app_id" =>'38b6575b617c44799c6936dc506e3903',
       "sender_id"=>'MDR_SPCB',
       "numbers" =>$number,
       "text"=>$text
    ...
    $curl = curl_init("http://obulk.orbit.co.ke/api/SendApi");
...
$diff = $t1->diff($t2);
 ...
 {
$URL='http://obulk.orbit.co.ke/api/SendApi';
$params = array('numbers' => $phone,
   'key'=>'38b6575b617c44799c6936dc506e3903',
  'sender_id'=>'MDR_CPSB',
  'text'=>$message2
...
public static function createNotification($user,$message_body,$subject=null,$sendEmail=true)
 {
    ...
    public static function emailCustomerCare($model){
      ...
      public static  function ReportDevError($e,$source=null)
  {
       try{
          ...
          if($source=="USSD")
          {
            ...
            $phone=(Auth::User())?Auth::User()->telephone:"Unknown";

          }
        $app_key="2y10ILjW2xoXPEcVx3p8pTtxe6JOrcxOlPqdS6akFkkxbkOcbp39r9O";
        $account_id=config('app.AccountID');
      $url="http://support.usnclex.info/api/post/DevelopmentError";
      $headers = array();
      $headers[] = "appkey:".$app_key;
      $headers[] = "Content-type:application/json";
      $post_field=array("errorTime"=>date('Y-m-d H:i:s'),
    "Line"=>$e->getLine(),
