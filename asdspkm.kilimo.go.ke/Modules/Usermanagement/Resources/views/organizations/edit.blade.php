  ...
  <input type="email" class="form-control" name="org_email" id="email" placeholder="Email Address" value="{{(isset($model->org_email))?$model->org_email:old('org_email')}}"  required>
                                        ...
                                        <div class="row">
                                           ...
                                           <div class="form-group col-md-6">
                                                                <label>Telephone</label>
                                                                  ...
                                                                  <input type="text"
                                                                  id="Phone" class="form-control" name="org_tephone" placeholder="Phone" value="{{$model->org_tephone}}" required >
                                       ...
                                       <div class="row">
                                                <div class="form-group col-md-6">
                                                       ...
                                                       <input type="text"
                                                                   class="form-control" name="ward_name" placeholder="Ward" value="{{$model->ward_name}}" required >
                                                     ...
                                                     <div class="form-group col-md-6">
                                                             ...
                                                             {{ Form::select('value_chain_id',([null=>'--Select Value--'] + $sub_counties), $model->value_chain_id, ['class'=>'form-control','required'=>'required','id'=>'ValueChain','style'=>'width:100%']) }}
