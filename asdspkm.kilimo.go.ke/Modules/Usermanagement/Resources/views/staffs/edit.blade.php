          ...
          <div class="col-md-12">
            <div class="widget box">
              <div class="widget-header">
                <h4><i class="icon-reorder"></i>Edit Staff Details</h4>
              ...
              <div class="widget-content"> 
                <form action="{{$url}}" method="post">
                   ...
                   <div class="col-md-4 form-group">
                    <label>Title</label>
                     {{ Form::select('title',([null=>'--Select Title--'] + $titles), $model->title, ['class'=>'form-control','required'=>'required','id'=>'Title','style'=>'width:100%']) }}
                     </div>
                    <div class="col-md-4 form-group">
                      <label>Full Names</label>
                      <input type="text" name="name" class="form-control" required value="{{($model->user)?$model->user->name:null}}" style="text-transform: uppercase;">
                    ...
                    <div class="col-md-4 form-group">
                      ...
                      <input type="email" name="email" class="form-control" required value="{{($model->user)?$model->user->email:null}}" >
                   ...
                   <div class="row">
                    <div class="col-md-4 form-group">
                      ...
                      <input type="text" name="dob" class="form-control" required value="{{$model->dob}}" id="from">
                      ...
                      <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-4">
                             ...
                             <div class="form-group col-md-4">
                                ...
                                {{ Form::select('qualification',([null=>'--Select Qualifications--'] +$qualifications), $model->qualification, ['class'=>'form-control','required'=>'required','id'=>'ethinicity','style'=>'width:100%']) }}
                    ...
                    <div class="col-md-4 form-group">
                      ...
                      <input type="text" name="date_employed" class="form-control" required value="{{$model->date_employed}}" id="to">
                     ...
                     <div class="col-md-4 form-group hidden contract">
                      <label>Contract Start Date</label>
                      <input type="text" name="contract_start_date" class="form-control mycontract"  value="{{$model->contract_start_date}}" id="to">
                     ...
                     <div class="form-group col-md-4 hidden disabled">
                                <label>NCPWD Reg No</label>
                                <input type="text" class="form-control npwd"  value="{{$model->ncpwd_regno}}" name="ncpwd_regno" >
                                
                  </div>
                     <div class="form-group col-md-4 hidden disabled">
                                <label>Disability Type</label>
                                <input type="text" class="form-control npwd"  value="{{$model->disability_type}}" name="disability_type" >
...
@push('scripts')
  ...
  <script type="text/javascript">
     ...
     var terms="<?=$model->employment_type?>";
           if(terms=="Contract")
           {
              $(".contract").removeClass("hidden");
                $(".mycontract").attr("required",true);
     ...
     var IsDisabled="<?=$model->living_with_disability?>";
         if(IsDisabled=="Yes")
         {
           $(".disabled").removeClass("hidden");
            $(".npwd").attr("required",true);
      ...
      $("body").on("change","#county",function(e){
        e.preventDefault();
          var id=$(this).val();
             if(id.length>0)
             {
                 var url="<?=url('/System/SubCounty/GetMySubCounties')?>/"+id;
