...
@section('content')
         ...
         <p>
                                    <a title="Add Success Story" href="<?=url('/System/SuccessStories/Create')?>" class="btn btn-sm btn-info"><span class="fa fa-plus"><span>New Success Story</a>
          ...
          <div class="form-group col-md-6">
             ...
             <div class="form-group col-md-12">
                ...
                <div class="form-group col-md-12">
                    ...
                    <input type="text" name="story_title"  class="form-control" required   value="{{old('story_title')}}">
                  </span>
         </div>
