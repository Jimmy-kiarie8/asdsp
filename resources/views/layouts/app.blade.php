  ...
  <header class="header navbar navbar-fixed-top" role="banner">
    ...
    <div class="container">
     ...
     <a class="navbar-brand" href="{{url('/home')}}">
       <strong>Innovation Portal</strong> 
      ...
      <div class="container">
        ...
        <div class="crumbs">
          ...
          <ul class="crumb-buttons">
            ...
            <li class="dropdown"><a href="#" title="" data-toggle="dropdown"><i class="icon-tasks"></i><span>ASDSP Innovation Portal <strong>(+4)</strong></span><i class="icon-angle-down left-padding"></i></a>
              <ul class="dropdown-menu pull-right">
                 <li><a href="{{url('home')}}" title=""><i class="icon-reorder"></i>Overview/Dashboard</a></li>
              <li><a href="{{url('/System/Users/Index')}}" title=""><i class="icon-user"></i>User Management</a></li>

               <li><a href="{{url('/System/Innovations/Index')}}" title=""><i class="icon-list"></i>Innovations Management</a></li>


               <li><a href="{{url('/System/SuccessStories/Index')}}" title=""><i class="icon-table"></i>Success Stories Management</a></li>

               <li><a href="{{url('/System/Publication/Index')}}" title=""><i class="icon-book"></i>Publication Management</a></li>
