  ...
  <div class="container px-6 md:px-12">
    ...
    <div class="flex flex-wrap">
        ...
        <div class="w-full shrink-0 grow-0 basis-auto lg:w-7/12">
          <div class="flex flex-wrap">
            <div class="mb-12 w-full shrink-0 grow-0 basis-auto md:w-4/12 md:px-3 lg:w-full lg:px-6 xl:w-6/12">
            ...
            <div class="mb-12 w-full shrink-0 grow-0 basis-auto md:mb-0 md:w-4/12 md:px-3 lg:mb-12 lg:w-full lg:px-6 xl:w-6/12">
            ...
            <div class="w-full shrink-0 grow-0 basis-auto md:w-4/12 md:px-3 lg:w-full lg:px-6 xl:mb-12 xl:w-6/12">
              <div class="align-start flex">
                <div class="shrink-0">
                  <div class="inline-block rounded-md bg-primary-100 p-4 text-primary">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="h-6 w-6">
...
<section class="bg-gray-50 light:bg-gray-900">
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
      <div class="flex flex-col justify-center">
          <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl light:text-white">Agriculture Sector Development Support Programme (ASDSP)          </h1>
          <p class="mb-6 text-lg font-normal text-gray-500 lg:text-xl light:text-gray-400">We welcome you to visit our office for any in-person inquiries. Please schedule an appointment through our customer support.</p>
