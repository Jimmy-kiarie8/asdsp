...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDEraSXsfbkYBnkCukdi5qTKRDoIaz4WUg&callback=initMap"></script>
...
<link href="https://fonts.googleapis.com/css2?family=Roboto:ital@1&display=swap" rel="stylesheet">
  ...
  <style>
    ...
    #hover-green:hover, #hover-green:hover p, #hover-green:hover h5 {
      background: #348a21;
      color: #fff
    }
  ...
  #column2 {
    border-left: 5px solid #348a21;
      flex:3; /* Take up two-thirds of the width */
      padding: 20px;
    }
