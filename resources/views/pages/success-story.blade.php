    ...
    <section class="bg-white light:bg-gray-900">
        <div class="py-8 px-4 lg:py-16">
            <div
                ...
                <p class="text-lg font-normal text-gray-500 light:text-gray-400 mb-6">The programme is implemented by the
                    Government of Kenya (National and 47 county governments) with strong participation of the private sector
                    as direct beneficiaries or service providers. It is financed by the Government of Kenya, Sida and EU for
                    a period of five years (2017-2022).</p>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                @foreach ($publications as $item)
                    <div
                        ...
                        <img class="rounded-t-lg" src="/uploads/{{ $item->story_cover_image }}" style="height: 350px"
                            alt="" />
                    ...
                    overflow: hidden;">
                            <p class="text-lg font-normal text-gray-500 light:text-gray-400 mb-4">
                        ...
                        <time class="block mb-2 text-sm font-normal leading-none text-gray-400 light:text-gray-500">Released
                            on
