    ...
    <section class="bg-white light:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
            <div
                ...
                <h1 class="text-gray-900 light:text-white text-3xl md:text-5xl font-extrabold mb-2">ASDSP COMMUNITY</h1>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                @foreach ($communities as $item)
                    <div
                        ...
                        <h2 class="text-gray-900 light:text-white text-3xl font-extrabold mb-2">{{ $item->title }}</h2>
                        <p class="text-lg font-normal text-gray-500 light:text-gray-400 mb-4">{{ $item->message }}</p>
                        <p href="#" class="text-sm pb-3">
                            By <a href="#" class="font-semibold hover:text-gray-800">{{ $item->name }}</a>, Published on
                            <b>{{ $item->created_at }}</b>
                        </p>
                        <a href="{{ route('community_detail', $item->id) }}"
