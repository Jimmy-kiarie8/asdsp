                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-md-6">
                                        <div class="event-card style5">
                                            <div class="event-img">
                                                <img src="{{asset('uploads/'.$innovation->story_cover_image)}}" alt="Image">
                                                <span class="event-date">{{$innovation->valuechain->value_name}}</span>
                                            </div>
                                            <div class="event-info">
                                                <h3><a href="{{url('/innovationdetails/'.$innovation->id)}}">{{  str_limit($innovation->story_title,26)}}</a></h3>
