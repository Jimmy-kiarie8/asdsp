                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <input type="email" name="member_number" readonly value="{{$model->member_email}}" class="form-control" id="MemberNumber">
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-4">
                      <label>Unit of Measure</label>
                          ...
                          {{ Form::select('uom',([null=>'--Select Units--'] + array()), $model->uom, ['class'=>'form-control','required'=>'required','id'=>'UOM','style'=>'width:100%']) }}
                    </div>
                    <div class="form-group col-md-4">
                      <label>Color</label>

                          {{ Form::select('product_color',([null=>'--Select Color--'] + array()), $model->product_color, ['class'=>'form-control','required'=>false,'id'=>'Color','style'=>'width:100%']) }}
                    </div>
                    <div class="form-group col-md-4">
                      <label>Size</label>

                          {{ Form::select('product_size',([null=>'--Select size--'] + array()), $model->product_size, ['class'=>'form-control','required'=>false,'id'=>'Size','style'=>'width:100%']) }}
                    </div>
                    <div class="form-group col-md-4">
