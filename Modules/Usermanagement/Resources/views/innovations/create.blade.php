...
@section('content')
         ...
         <p>
                                    <a title="Add New Department" href="<?=url('/System/Innovations/Create')?>" class="btn btn-sm btn-info"><span class="fa fa-plus"><span>New Innovation</a>
                                        ...
                                        <a href="<?=url('/System/Innovations/Index')?>" class="btn btn-sm btn-success"><span class="fa fa-bars"><span>List of Innovations</a>
                                          ...
                                          <a href="<?=url('/System/Innovations/Import')?>" class="btn btn-sm btn-danger"><span class="fa fa-bars"><span>Import</a>
        ...
        <div class="row">
            ...
            <div class="widget box">
              ...
              <div class="widget-content"> 
                ...
                <div class="form-group col-md-12">
                    ...
                    <input type="text" name="inno_name"  class="form-control" required   value="{{old('inno_name')}}">
                  </span>
         </div>
         ...
         <div class="form-group col-md-6">
            ...
            {{ Form::select('subcounty',([null=>'--Select Sub County--'] + $sub_counties), $model->innovation_type, ['class'=>'form-controls','required'=>'required','id'=>'SubCounty','style'=>'width:100%']) }}
                              ...
                              <div class="form-group col-md-6">
            <label>Ward</label>
            <input type="text" name="wardname" class="form-control" required   value="{{old('wardname')}}">
          ...
          <div class="form-group col-md-6">
            ...
            <input type="text" name="inno_location" class="form-control"   value="{{old('inno_location')}}">

          </div>
           <div class="form-group col-md-3">
            <label>Longitude</label>
            <input type="text" name="inno_longitude" class="form-control" required id="lon"  value="{{old('inno_longitude')}}">

          </div>
           <div class="form-group col-md-3">
            <label>Latitude</label>
            <input type="text" id="lat" name="inno_latitude" class="form-control" required  value="{{old('inno_latitude')}}">
          ...
          <div class="form-group col-md-6">
            ...
            <input type="text" name="org_id" class="form-control" value="{{old('org_id')}}" required>
            ...
            <label>Innovation Source</label>
              {{ Form::select('inno_sources',([null=>'--Select Source--'] + array("Government Institutions"=>"Government Institutions","County ASDSP II offices"=>"County ASDSP II offices")), $model->inno_sources, ['class'=>'form-control','required'=>false,'id'=>'LibrarSy','style'=>'width:100%']) }}
         </div>
    ...
    <div class="row">
       ...
       <div class="form-group col-md-6">
            ...
            <input type="text" name="inno_male_adultvca"  class="form-control" required   value="{{old('inno_male_adultvca')}}">
         </div>
        <div class="form-group col-md-6">
            <label>Total Adult Female Beneficiaries </label>
            <input type="text" name="inno_female_adultvca"  class="form-control" required   value="{{old('inno_female_adultvca')}}">
         </div>

          <div class="form-group col-md-6">
            <label>Total Youths Male Beneficiaries </label>
            <input type="text" name="inno_youth_malevca"  class="form-control" required   value="{{old('inno_youth_malevca')}}">
         </div>
          <div class="form-group col-md-6">
            <label>Total Youths Female Beneficiaries </label>
            <input type="text" name="inno_youth_femalevca"  class="form-control" required   value="{{old('inno_youth_femalevca')}}">
         </div>
         ...
         <input type="hidden" name="innovation_output" value="0">
            ...
            <input type="text" name="inno_contactname"  class="form-control" required   value="{{old('inno_contactname')}}">
         </div>
           ...
           <div class="form-group col-md-6">
            ...
            <input type="text" name="inno_contacttel"  class="form-control" required   value="{{old('inno_contacttel')}}">
         </div>
                          ...
                          <div class="col-md-4">
                            <label>Cover Image</label>
                             <div>
                  <img name="images" width="220" height="350" id="image_array1" value="" src="{{asset('placeholder.png')}}" style="width: 100%;height: 250px;" />
...
pasteFromWordRemoveFontStyles:false,
   ...
   CKEDITOR.replace('PracticalUtility', { height: 200,
...
pasteFromWordRemoveFontStyles:false,
   ...
   CKEDITOR.replace('Objectives', { height: 100,
     font_defaultLabel:'Arial',
fontSize_defaultLabel:'12pts',
pasteFromWordRemoveFontStyles:false,
    });
   ...
   CKEDITOR.replace('Background', { height: 100,
     font_defaultLabel:'Arial',
fontSize_defaultLabel:'12pts',
pasteFromWordRemoveFontStyles:false,
    });
   ...
   CKEDITOR.replace('Impact', { height: 200,
     font_defaultLabel:'Arial',
fontSize_defaultLabel:'12pts',
pasteFromWordRemoveFontStyles:false,
