        ...
        <div class="col-md-12">
            <div class="widget box">
                <div class="widget-header">
                    <h4><i class="icon-reorder"></i>Edit New Innovation</h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>Ward</label>
                                            <input type="text" name="inno_ward" class="form-control" required
                                                value="{{ $model->inno_ward }}">
