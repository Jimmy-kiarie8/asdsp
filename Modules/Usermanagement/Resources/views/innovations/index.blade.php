            ...
            <div class="widget box">
                ...
                <div class="widget-content">
                    <div class="table-responsive" style="overflow-x:auto;">
                        <table class="table table-striped table-bordered table-hover " id="role-datatable"
                            style="width:100%;">
                            <thead>
        ...
        $('#role-datatable').DataTable({
            ...
            columnDefs: [{
                    render: function(data, type, full, meta) {
                        return "<div id='dvNotes' style='white-space: normal;width: 200px;'>" + data +
                            "</div>";
                    },
                    targets: [3, 4]
                },
            ...
            columns: [{
                ...
                {
                    data: 'inno_cover_image',
                    name: 'inno_cover_image'
                },
                {
                    data: 'vco_name',
                    name: 'vco_name'
                ...
                {
                    data: 'inno_vca_benefit',
                    name: 'inno_vca_benefit'
                },
                {
                    data: 'inno_male_vca',
                    name: 'inno_male_vca'
                ...
                {
                    data: 'inno_female_vca',
                    name: 'inno_female_vca'
                },
                {
                    data: 'inno_youth_vca',
                    name: 'inno_youth_vca'
                ...
                {
                    data: 'inno_contactname',
                    name: 'inno_contactname'
                },
                {
                    data: 'inno_contacttel',
                    name: 'inno_contacttel'
                },
                {
                    data: 'publish_status',
                    name: 'publish_status'
