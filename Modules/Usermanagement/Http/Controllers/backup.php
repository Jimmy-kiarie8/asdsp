...
class OrgainizationController extends Controller
{
  ...
  public function __construct()
    ...
    {
       $models=Organization::where(['county_id'=>$id])->get();
...
$path=storage_path('app').'/'.$path1; 
                 ...
                 array_splice($array[0], 0, 1);
                            ...
                            $contact_name=str_replace("-", "", $contact_name);
                              $contact_name=str_replace("’", "", $contact_name);
                                ...
                                $nodemodel=NodeType::where(['node_name'=>$node])->first();
                                 ...
                                 $valueChainModel=ValueChain::where(['value_name'=>$valueChain])->first();
                    ...
                    $model->save();
                   // ALTER TABLE `uploads` CHANGE `id` `id` BIGINT(10) UNSIGNED NOT NULL AUTO_INCREMENT;
